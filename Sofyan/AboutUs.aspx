    ...
    <form id="form1" runat="server">
     <div>
         ...
         <header class="header">
             ...
             <img class="logo" style="width: 13%" src="Logo.png" />
             <nav class="navbar">
             ...
             <%--    <asp:LinkButton ID="lnkLogin" runat="server" CssClass="btn btn-success btnLogin" OnClick="lnkLogin_Click">
                 ...
                 <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn-login" Visible="false" OnClick="btnLogin_Click" />
                  <asp:Button ID="btnRegister" runat="server" Text="Register" CssClass="btn-register" Visible="false" OnClick="btnRegister_Click" />
<asp:Button ID="btnLogout" runat="server" Text="Logout" CssClass="btn-logout" Visible="true" OnClick="btnLogout_Click" />
                 <asp:Button ID="profile" runat="server" Text="Profile" CssClass="btn-logout" Visible="true" OnClick="profile_Click" />
         ...
         <section class="about" id="about">
             ...
             <div class="row">
                 <div class="image">
                     <asp:Image ID="Image5" runat="server" ImageUrl="about-img.png" AlternateText="About Us Image" />
                 </div>
                 <div class="content">
                     ...
                     <div class="icons-container">
                         <div class="icons">
                             <asp:Image ID="Image6" runat="server" ImageUrl="about-icon-1.png" AlternateText="Quality Coffee" />
                             <h3>Fresh Coffee</h3>
                         </div>
                         <div class="icons">
                             <asp:Image ID="Image7" runat="server" ImageUrl="private_company.png" AlternateText="Our Branches" />
                             <h3>Private Areas</h3>
                         </div>
                         <div class="icons">
                             <asp:Image ID="Image8" runat="server" ImageUrl="library.png" AlternateText="Free Delivery" />
